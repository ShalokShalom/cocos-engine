...
**Cocos Creator is the new generation of game development tools in the Cocos family. It brings a complete set of 3D and 2D features while providing an intuitive, low-cost, and collaboration-friendly workflow to game developers.** Cocos Engine is the runtime framework for the Cocos Creator editor.

![image](./ui.png)

Cocos Creator inherited many good qualities and cool features from its previous versions, such as high-performance low-level C++ implementation, intuitive editor, and cross-platform support. It supports native platforms, web platforms, and rapidly expanding instant gaming platforms, including Windows, Mac, iOS, Android, HarmonyOS, Web, Facebook Instant Games, WeChat Mini Game, and TikTok Mini Games.

Furthermore, Cocos Creator has pushed engine technology to a whole new level, delivering high performance with scalability on various platforms, full extensibility, and easy development.

1. **Modern Graphics**: The GFX implementation is designed to adapt to the modern graphics APIs, it uses Vulkan on Linux, Windows, and Android, Metal on Mac OS and iOS, and WebGL on Web platforms.
...
2. Participatein  discussions in the [issues](https://github.com/cocos/cocos-engine/issues/).
